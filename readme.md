...
### **Belirttiğim manuel yüklemeyle çalışan örnek burada. Local bilgisayarımda çalıştırabildiğim şekilde maalesef çalıştıramadım, belge yükleme mantığı olduğundan dolayı yapıyı tekrar kuramadım ve bozdum. Belge yüklemeli çalışan versiyonu bu şekilde. Denemek için yine başlıkta da belirttiğim huggingface linkini yine buraya da ekliyorum.** https://huggingface.co/spaces/alperenkk/PartialDischargeDetector
